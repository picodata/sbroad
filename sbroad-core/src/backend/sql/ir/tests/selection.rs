...
fn selection2_latest() {
    ...
    let expected = PatternWithParams::new(
            [
                r#"SELECT "hash_testing"."product_code" FROM "hash_testing" WHERE"#,
                r#"(((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((("hash_testing"."identification_number","#,
                r#""hash_testing"."identification_number","#,
                r#""hash_testing"."product_code") = ("hash_testing"."product_code", ?, ?)"#,
                r#"and ("hash_testing"."identification_number") < ("hash_testing"."product_code")"#,
                r#"and ("hash_testing"."product_units") <> ("hash_testing"."sys_op")"#,
                r#"or ("hash_testing"."identification_number", "hash_testing"."identification_number","#,
                r#""hash_testing"."product_code") = ("hash_testing"."product_code", ?, ?)"#,
                r#"and ("hash_testing"."identification_number") < ("hash_testing"."product_code")"#,
                ...
                r#"and ("hash_testing"."identification_number") < ("hash_testing"."product_code")"#,
                r#"and ("hash_testing"."product_units") is null)"#,
                r#"or ("hash_testing"."product_code", "hash_testing"."identification_number","#,
                r#""hash_testing"."product_code") = ("hash_testing"."identification_number", ?, ?)"#,
                r#"and ("hash_testing"."identification_number") < ("hash_testing"."product_code")"#,
                r#"and ("hash_testing"."product_units") <> ("hash_testing"."sys_op"))"#,
                r#"or ("hash_testing"."product_code", "hash_testing"."identification_number","#,
                r#""hash_testing"."product_code") = ("hash_testing"."identification_number", ?, ?)"#,
...
fn selection2_oldest() {
    ...
    let expected = PatternWithParams::new(
        format!(
            ...
            r#"SELECT "hash_testing"."product_code" FROM "hash_testing""#,
            r#"WHERE ("hash_testing"."identification_number") in"#,
            r#"(?, ?, ?, ?, ?, ?, ?) and ("hash_testing"."product_code") in"#,
            r#"(?, ?, ?, ?, ?, ?, ?) and ("hash_testing"."identification_number") < ("hash_testing"."product_code")"#,
